...
class ManageBookings:
    def __init__(self, logged_in_data=""):
        ...
        self.t.title("Manage Bookings | Airline Reservation | Manager Panel")
    ...
    def widgets(self):
        self.image_path = Image.open('manager/images/img5.jpg')
        ...
        self.i.create_text(430, 50, text='BOOKINGS DETAILS', fill='Black',
        ...
        data = database.get_bookings((self.loggedInData[3],))
        for i in data:
