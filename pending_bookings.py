...
class PendingBookings:
    def __init__(self, logged_in_data=""):
        ...
        self.t.title("Pending Bookings | Airline Reservation | Manager Panel")
    ...
    def widgets(self):
        self.image_path = Image.open('manager/images/img7.jpg')
        ...
        self.i.create_text(400, 50, text='PENDING BOOKINGS DETAILS', fill='Black',
        ...
        data = database.get_pending_bookings((self.loggedInData[3],))
        for i in data:
